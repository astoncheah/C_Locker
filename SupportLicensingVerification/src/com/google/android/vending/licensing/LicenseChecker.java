...
public class LicenseChecker implements ServiceConnection {
    ...
    private Set<LicenseValidator> mChecksInProgress = new HashSet<LicenseValidator>();
    private Queue<LicenseValidator> mPendingChecks = new LinkedList<LicenseValidator>();
