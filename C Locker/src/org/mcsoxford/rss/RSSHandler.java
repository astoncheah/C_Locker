...
class RSSHandler extends org.xml.sax.helpers.DefaultHandler{
     ...
     */
    private java.util.Map<String,Setter> setters;
    /**
     ...
     * {@link #item} is set.
     */
    private Setter SET_TITLE = new ContentSetter(){
        @Override
     ...
     * {@link #item} is set.
     */
    private Setter SET_DESCRIPTION = new ContentSetter(){
        @Override
     ...
     * element.
     */
    private Setter SET_CONTENT = new ContentSetter(){
        @Override
     ...
     * {@link #item} is set.
     */
    private Setter SET_LINK = new ContentSetter(){
        @Override
     ...
     * {@link #item} is set.
     */
    private Setter SET_PUBDATE = new ContentSetter(){
        @Override
     ...
     * {@link #item} is set.
     */
    private Setter ADD_CATEGORY = new ContentSetter(){
     ...
     */
    private Setter ADD_MEDIA_THUMBNAIL = new AttributeSetter(){
