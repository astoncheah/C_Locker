...
public final class GmailContract{
     ...
     */
    public static boolean isGmailSupported(Context context){
        boolean supported = false;
        try{
            final PackageInfo info = context.getPackageManager().getPackageInfo(PACKAGE,PackageManager.GET_PROVIDERS | PackageManager.GET_PERMISSIONS);
