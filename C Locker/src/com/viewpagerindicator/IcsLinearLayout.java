...
class IcsLinearLayout extends LinearLayout{
    ...
    public void setDividerDrawable(Drawable divider){
        if(divider==mDivider){
            Log.e("info","IcsLinearLayout>setDividerDrawable: divider == mDivider");
            return;
        }
        mDivider = divider;
        if(divider!=null){
            ...
            Log.e("info","IcsLinearLayout>setDividerDrawable: divider != null");
        }else{
            mDividerWidth = 0;
            mDividerHeight = 0;
            Log.e("info","IcsLinearLayout>setDividerDrawable: divider == null");
    ...
    protected void onDraw(Canvas canvas){
        if(mDivider!=null){
            ...
            Log.e("info","IcsLinearLayout>onDraw: mDivider != null");
        }
        super.onDraw(canvas);
    }
    ...
    protected void measureChildWithMargins(View child,int parentWidthMeasureSpec,int widthUsed,
        ...
        Log.e("info","IcsLinearLayout>measureChildWithMargins>index: "+index);
        if(hasDividerBeforeChildAt(index)){
            ...
            Log.e("info","IcsLinearLayout>measureChildWithMargins: hasDividerBeforeChildAt");
        }
        ...
        if(index==count-1){
            if(hasDividerBeforeChildAt(count)){
                if(orientation==VERTICAL){
                    ...
                    Log.e("info","IcsLinearLayout>measureChildWithMargins>index: mDividerHeight");
                }else{
                    params.rightMargin = mDividerWidth;
                    Log.e("info","IcsLinearLayout>measureChildWithMargins>index: mDividerWidth");
                }
                Log.e("info","IcsLinearLayout>measureChildWithMargins>index>hasDividerBeforeChildAt");
            }
            Log.e("info","IcsLinearLayout>measureChildWithMargins: index == count - 1");
        }
